...
const storageConfig = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(null, path.join('public', 'resume')); //Here null means no errors. and second parameter is for the storage location where we want to store the client uploaded files.
  },
